...
\begin{registromodifiche}
        \lastversion & 26 Marzo 2025 & Pedro Leoni &  & Stesura verbale interno \\
        \hline 
...
\begin{itemize}
    \item Assegnazione del Resposabile e dei Verificatori in modo fisso indipendentemente dalle attività da portare a termine nello \glossario{sprint}.
    Il Responsabile così può essere più presente e seguire il lavoro degli altri membri con più attenzione.
    Inoltre si cerca di evitare un problema riscontrato in passato in cui le verifiche arrivavano in ritardo.

    \item Modifica data della milestone relativa alla Product Baseline al giorno 30 Maggio 2025.
    La data inizialmente stabilita (20 Aprile 2025) dopo una rivalutazione della pianificazione per tenere in conto lo stato di avanzamento attuale del progetto è stata definita insufficiente; 

    \item Modifica delle ore per ruolo preventivate sottraendo ore ai ruoli Programmatore e Analista in favore dei ruoli Progettista e Verificatore.
    ...
    Inoltre ponendo più attenzione alla attività di progettazione e stesura dei test il gruppo ha preventivato di riuscire eseguire l'attività di codifica in due \glossario{sprint};  
