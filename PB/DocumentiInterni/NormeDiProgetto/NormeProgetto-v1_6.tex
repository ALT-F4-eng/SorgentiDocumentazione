...
%--------------------VARIABILI--------------------
\def\lastversion{v1.6}
\def\title{Norme di progetto}
\def\date{26 Marzo 2025}
%------------------------------------------------
...
\begin{registromodifiche}
        \lastversion & 25 Marzo 2025 & Francesco Savio & Pedro Leoni & Correzione processo \hyperref[subsec:gestione_della_configurazione]{Gestione della configurazione}, aggiunta sezione \hyperref[sec:strumenti]{Strumenti}\\
    \hline
