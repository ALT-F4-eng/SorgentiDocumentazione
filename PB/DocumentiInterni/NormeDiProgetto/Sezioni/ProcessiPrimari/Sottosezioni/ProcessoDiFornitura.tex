...
\begin{enumerate}
    ...
    \item \textbf{Requisiti software}: Elenco completo dei requisiti software del prodotto, suddivisi in funzionali e non funzionali.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{\glossario{Cruscotto di valutazione} della qualità}: Vengono visualizzati i grafici relativi ai valori delle \glossario{metriche} e una loro analisi. Il cruscotto di qualità viene
