...
\begin{itemize}
    ...
    \begin{enumerate}
        \item \textbf{Obiettivi}: definisce gli obiettivi specifici dello \glossario{sprint} si suddivide in: 
            \begin{itemize}
                \item \glossario{issue} pianificate per lo \glossario{sprint};
                \item diagramma di Gantt per membro e ruolo, con le attività pianificate.
            \end{itemize}
        \item \textbf{Preventivo}: presenta il preventivo dei costi e delle risorse previste per lo \glossario{sprint} indicando anche i tempi di fine preventivati per le varie attività, sia in maniera tabellare che tramite un diagramma a torta.
        \item \textbf{Consuntivo}: presenta il consuntivo dei costi e delle risorse usate per lo \glossario{sprint} indicando anche i tempi di fine delle varie attività, sia in maniera tabellare che tramite un diagramma a torta.
        \item \textbf{Retrospettiva}: riporta la conclusione dello \glossario{sprint} e valuta i rischi che sono emersi, come sono stati mitigati e se ciò non è avvenuto come verranno mitigati.
        \item \textbf{Aggiornamento risorse rimaste}: aggiorna la situazione delle risorse disponibili per il progetto.
        \item \textbf{Aggiornamento piano}: aggiorna il piano di progetto con le modifiche apportate durante lo \glossario{sprint}. Indicandone cambiamenti e motivazioni per esse.
        \item \textbf{Aggiornamento rischi}: riporta i rischi che sono emersi durante lo \glossario{sprint} e si suddivide nelle seguenti sezioni: 
            \begin{itemize}
                \item rischi incontrati durante lo sprint;
                \item rischi che si è riusciti a mitigare;
                \item soluzioni adottate per mitigare i rischi;
                \item rischi che non sono stati mitigati;
                \item soluzioni proposte per mitigare i rischi non mitigati.
            \end{itemize}
    \end{enumerate}
\end{itemize}
