...
\begin{itemize}
    ...
    \item Le classi responsabili della comunicazione e del coordinamento tra i modelli e le view risiedono in \texttt{backend/controller}, facilitando l’implementazione del pattern MVC (Model-View-Controller) e migliorando la manutenibilità del codice.
\end{itemize}
...
\begin{itemize}
    ...
    \item Adottare strumenti di linting e testing, che permettano di individuare tempestivamente eventuali anomalie e di mantenere elevati standard qualitativi.
\end{itemize}
...
\begin{itemize}
    \item Si raccomanda l’adozione di metodologie di naming (ad es. BEM) per facilitare l’organizzazione e la manutenzione dei fogli di stile.
...
\begin{itemize}
    ...
    \item È imprescindibile adottare le specifiche W3C, garantendo così la validità del markup e la compatibilità con i browser moderni.
\end{itemize}
