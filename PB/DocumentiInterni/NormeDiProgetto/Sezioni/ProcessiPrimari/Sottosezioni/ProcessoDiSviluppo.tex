...
Il testing è una fase fondamentale del processo di sviluppo, volta a garantire la qualità e l'affidabilità del software, realizzata in parallelo all'attività di codifica.
...
I test di unità sono una tipologia di test software che verificano il corretto funzionamento delle singole unità o componenti del codice, come funzioni, metodi o classi, in isolamento. 
...
Questo viene fatto attraverso l'utilizzo di strumenti di automazione e framwork specifici per i linguaggi di programmazione adottati durante lo sviluppo.
...
\begin{itemize}
    ...
    Questo approccio è utile quando si vuole verificarel'integrazione delle funzionalità principali, prima di testare i dettagli più specifici.
\end{itemize}
...
\begin{itemize}
    ...
    \item I test, a meno di modifica, devono produrre gli stessi risultati ad ogni loro esecuzione;
