...
Il gruppo ha deciso di utilizzare \glossario{Git} come software per il controllo di versione.
I motivi di questa scelta sono:
\begin{enumerate}
    \item \glossario{Git} è abbastanza conosciuto dai membri del gruppo.
    \item \glossario{Git} è molto usato e quindi una conoscenza approfondita dello stesso è molto utile.
\end{enumerate}
Di seguito vengono fornite delle informazioni teoriche sulle scelte fatte dal gruppo sulla gestione del \glossario{repository}.
...
Una modifica è intesa come un azione che ha lo scopo di modificare lo stato di uno o più file appartenenti all'ultima \glossario{baseline} raggiunta in un \glossario{repository}. 
...
\item Colmare la necessità della richiesta di cambiamento assicurandosi di soddisfare la \glossario{check list}.
...
\item \hyperref[subpar:github_richiesta_di_verifica]{Richiesta di verifica} aggiungendo nel primo commento della
 \glossario{pull request} i seguenti campi:
 \begin{enumerate}
    \item closes \#\textless ID della \glossario{issue} che richiede la verifica\textgreater
    \item Tempo impiegato: \textless numero delle ore effettive usate per svolgere la \glossario{issue}\textgreater
 \end{enumerate}
...
\begin{enumerate}
    ...
    \item Verificare i cambiamenti seguendo le regole indicate nella sezione \hyperref[subsec:proc_verifica]{Verifica}.
