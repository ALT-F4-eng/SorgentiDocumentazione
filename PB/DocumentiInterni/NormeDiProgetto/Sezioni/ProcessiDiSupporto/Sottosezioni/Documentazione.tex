...
Questa attività inizia con l'approvazione finale del documento da parte del responsabile in carica e, nel caso di verbali destinati all'uso esterno, anche da parte del Proponente. Successivamente, il documento viene pubblicato nell'apposito repository G della documentazione.
...
\begin{itemize}
    ...
    \item Una volta completata la bozza con tutto il contenuto necessario, il redattore elabora una versione del documento conforme alle norme e ai metodi definiti in queste norme.
...
\begin{enumerate}
    ...
    Indica una lista delle cose da fare nel prossimo \glossario{sprint} collegandole alle informazioni di gestione della configurazione.
\end{enumerate}
