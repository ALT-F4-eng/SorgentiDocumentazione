...
\subparagraph{Input}
Gli input per la stesura di questi documenti derivano direttamente dalla riunione interna eseguita.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        Contiene il preventivo orario e il preventivo economico per lo \gloassario{sprint};


        \item \textbf{Consuntivo}
        
        Contine il consuntivo orario e il consuntivo economico per lo print;
        ...
        \item \textbf{Aggiornamento richi}
