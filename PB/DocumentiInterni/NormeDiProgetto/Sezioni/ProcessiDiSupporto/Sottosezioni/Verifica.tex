...
L'\glossario{analisi dinamica} è un approccio all'analisi di sistemi informatici e prodotti software che si concentra sull'osservazione e verifica
...
\end{itemize}
All'interno del \hyperref[subsection:processo_sviluppo]{processo di Sviluppo}, nello specifico nella sezione di \hyperref[subsubsec:testing_codice]{testing di codice}, vi è una descrizione 
