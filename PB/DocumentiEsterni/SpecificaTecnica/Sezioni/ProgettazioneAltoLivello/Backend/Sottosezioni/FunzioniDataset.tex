...
\begin{itemize}
    ...
    \item Restituisce un JSON con lo stato della risposta e, in caso di successo, la lista dei dataset.
\end{itemize}

\subsubsection{get\_dataset}
\paragraph{Descrizione}
La funzione \texttt{get\_dataset} permette di recuperare i metadati di un dataset salvato tramite un identificatore (ID) fornito.
\paragraph{Dettagli dell'endpoint}
\begin{itemize}
    \item \textbf{HTTP method}: GET;
...
\begin{itemize}
    ...
    \item Restituisce un JSON con lo stato della risposta e, in caso di successo, i dati richiesti.
\end{itemize}

\subsubsection{get\_dataset\_page}
\paragraph{Descrizione}
La funzione \texttt{get\_dataset\_page} permette di recuperare la pagina di un dataset salvato avente identificatore (ID) fornito.
\paragraph{Dettagli dell'endpoint}
\begin{itemize}
    \item \textbf{HTTP method}: GET;
    \item \textbf{Endpoint}: /datasets/\textless dataset\_id\textgreater;
...
\begin{itemize}
    ...
    \item Restituisce un JSON con lo stato della risposta e, in caso di successo, il dataset appena creato.
\end{itemize}
...
\begin{itemize}
    ...
    \item Restituisce un JSON contenente il risultato della richiesta e, in caso di successo il dataset aggiornato.
\end{itemize}
