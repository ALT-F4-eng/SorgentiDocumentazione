...
\begin{itemize}
        ...
        \item \textbf{FieldReqComponent}: Tale componente funge da wrapper per la chiamata HTTP di salvataggio per la conversione del tipo ritornato dalla chiamata, in un tipo consono alla logica del componente LLMComponent.
    \end{itemize}
