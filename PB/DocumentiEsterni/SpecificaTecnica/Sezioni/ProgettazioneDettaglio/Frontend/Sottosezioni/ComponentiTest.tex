...
\textbf{Input}:
\begin{itemize}
    \item \textbf{totalItem}: il numero totale di elementi presenti nella database.
    \item \textbf{pageSize}: il numero che indica quanti elementi da presentare nella pagina.
    \item \textbf{currentPage}: la pagina corrente.
\end{itemize}
\textbf{Output}:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{ClearIcon}: icona cliccabile per cancellare il campo di input;
\end{itemize}
\textbf{Output}:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{TestDatasetName}: sezione testuale contenente il nome del dataset associato al test;
    \item \textbf{RenameButton}: pulsante per richiedere la rinominazione del test, questa viene poi effettuata tramite il sottocomponente \textbf{TestNameDialog};
...
\begin{itemize}
    ...
    \item \textbf{SaveButton}: pulsante che permette il salvataggio del test se è temporaneo, viene successivamente richiesto di assegnargli un nome tramite il sottocomponente \textbf{TestNameDialog};
...
\textbf{Input}:
\begin{itemize}
    \item \textbf{Results}: lista dei risultati da visualizzare;
\end{itemize}
\textbf{Output}:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{ScatterElement}: singolo punto del diagramma di dispersione interagibile, l'interazione viene gestita tramite il sottocomponente \textbf{ResultElement};
...
\textbf{Input}:
\begin{itemize}
    \item \textbf{ElementValues}: lista delle coordinate dei punti da rappresentare;
    \item \textbf{ComparedElementValues}: liste delle coordinate dei punti da rappresentare nel caso di confronto tra test;
\end{itemize}
...
\begin{itemize}
    \item \textbf{Question}: sezione testuale contenente la domanda effettuata;
    \item \textbf{ExpectedAnswer}: sezione testuale contenente la risposta attesa dei test;
...
\begin{itemize}
    \item \textbf{question}: domanda effettuata;
    \item \textbf{expectedAnswer}: risposta attesa dei test;
