...
\begin{enumerate}
    ...
    \item \textbf{server}: applicazione che riceve ed elabora le richieste eseguite dal client e fornisce le risposte corrette. 
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{back-end}: componente server del sistema che utilizza Python come linguaggio e Flask come framework, implementa la logica di business e la logica di persistenza.
\end{enumerate}
...
Per gestire e permettere la comunicazione tra i due container menzionati, il gruppo ha deciso di utilizzare Docker Compose.  
