...
\begin{usecase}{UC-42}{Confronta test salvati}
    \label{uc:UC-42}
...
\begin{usecase}{UC-43}{Visualizza confronti singoli risultati}
    \label{uc:UC-43}
    ...
    \inc{\hyperref[uc:UC-44]{UC-44}}
    
    \base{}
    
    \scenario{
        \item Il sistema visualizza la prima pagina di risultati seguendo \hyperref[uc:UC-44]{UC-44}
    }
...
\begin{usecase}{UC-44}{Visualizza pagina confronto singoli risultati}
    \label{uc:UC-44}
...
\begin{usecase}{UC-45}{Cambia pagina confronto singoli risultati}
    \label{uc:UC-45}
    ...
    \scenario{
        ...
        \item Viene visualizzata la pagina richiesta seguendo \hyperref[uc:UC-44]{UC-44}
    }
