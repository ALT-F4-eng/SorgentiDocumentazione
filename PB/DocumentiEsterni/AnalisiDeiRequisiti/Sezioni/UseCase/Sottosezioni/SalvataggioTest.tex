...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{Sezioni/UseCase/Immagini/SalvataggioTest.png}
    \caption{Salvataggio test.}
\end{figure}

\begin{usecase}{UC-35}{Salva test di cui si stanno visualizzando i risultati}
    \label{uc:UC-35}
    ...
    \scenario{
        ...
        \item Il sistema ottiene il nome per il nuovo test seguendo \hyperref[uc:UC-14]{UC-14}
