...
\begin{tabularx}{\textwidth}{|c|X|c|}
    ...
    \begin{itemize}
        ...
        \item viene visualizzata correttamente la chiave associata alle domande da porre al LLM;
        \item viene visualizzata correttamente la chiave da utilizzare per estrarre la risposte date dal LLM;
        \item viene visualizzato correttamente il pulsante che permette di modificare LLM attuale;
    \end{itemize}
    & - \\
    \hline
    ...
    \begin{itemize}
        ...
        \item la copia creata deve avere nome che segue lo schema $nome\_dataset\_sorgente-copy-<n>$ dove $n$ è un numero crescente che indica l'ultima copia creata per il dataset;
    ...
    \begin{itemize}
        ...
        \item nel caso in cui la creazione del nuovo dataset temporaneo generi un errore di persistenza il metodo deve lanciare un eccezione di tipo PersistenceException;
    \end{itemize} & - \\
    \hline 
    ...
    \begin{itemize}
        \item se il dataset da aggiornare è temporaneo allora il metodo deve salvarlo;
        \item se il dataset da aggiornare è salvato allora il metodo deve limitarsi ad aggiornarlo;
        \item se il dataset da aggiornare è una working copy di un dataset salvato il metodo deve lanciare un eccezione di tipo InvalidDatasetOperationException;
    ...
    \begin{itemize}
        \item deve ottenere la risposta dal llm e se avviene un errore di comunicazione deve lanciare un eccezione di tipo LlmComunicationException. 
    \end{itemize} & - \\
    \hline 
    ...
    \begin{itemize}
        \item deve ottenere il responso sulla correttezza interrogando il llm esterno e nel caso in cui avvenga un errore di comunicazione deve lanciare un eccezione di tipo LlmComunicationException; 
        \item deve restituire un valore booleano che specifica la correttezza della risposta ottenuta dal LLM rispetto alla risposta attesa.
    \end{itemize} & - \\
    \hline 
    ...
    \begin{itemize}
        ...
        \item se la query string in input non è vuota il metodo deve restituire solo gli llm salvati che contengono nel proprio nome la query string;
    ...
    \begin{itemize}
        ...
        \item deve eliminare il LLM salvato indicato;
    ...
    \begin{itemize}
        \item se il nome del LLM è già utilizzato deve lanciare un eccezione di tipo DuplicateLlmException;
    ...
    \begin{itemize}
        \item deve restituire un optional vuoto se il dataset con l'id indicato non esiste o avviene un errore di persistenza; 
    ...
    \begin{itemize}
        \item deve restituire un optional a valore null se il dataset richiesto non esiste;
    ...
    \begin{itemize}
        \item deve restituire un optional vuoto se la coppia con l'id indicato non esiste o avviene un errore di persistenza; 
    ...
    \begin{itemize}
        \item deve copiare tutte le domande contenute nel dataset indicato come sorgente all'interno del dataset indicato come destinazione;
    ...
    \begin{itemize}
        ...
        \item deve restituire i risultati associati al test indicato che contengono la query string nella propria domanda, risposta o risposta ottenuta e che in ordine di salvataggio partono dallo start e terminano all'offset indicati.
    \end{itemize} & - \\
    \hline 
    ...
    \begin{itemize}
        \item deve restituire la stringa ottenuta dal LLM interrogato;
    ...
    \begin{itemize}
        \item se il LLM non esiste deve restituire un optional vuoto.
    \end{itemize} & - \\
    \hline 
    ...
    \begin{itemize}
        \item se il LLM da eliminare non esiste o se avviene un errore di persistenza deve restituire un optional vuoto;
        \item deve eliminare il LLM e tutti i test ad esso associati compresi i loro risultati. 
    \end{itemize} & - \\
    \hline 
...
\begin{itemize}
        ...
        \item viene visualizzata correttamente l'etichetta "Question Key" del campo di inserimento della chiave associata alle domande da porre al LLM;
        \item viene visualizzato correttamente il campo di inserimento della chiave associata alle domande da porre al LLM;
        \item è possibile inserire caratteri compresi da UTF-8 all'interno del campo di inserimento della chiave associata alle domande da porre al LLM;
        
        \item viene visualizzata correttamente l'etichetta "Answer Key" del campo di inserimento della chiave associata alla risposta fornita dal LLM;
        \item viene visualizzato correttamente il campo di inserimento della chiave associata alla risposta fornita dal LLM;
        \item è possibile inserire caratteri compresi da UTF-8 all'interno del campo di inserimento della chiave associata alla risposta fornita dal LLM;
