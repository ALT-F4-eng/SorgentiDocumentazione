...
La qualità di processo si riferisce all'efficacia con cui vengono implementati e gestiti i processi durante il \glossario{ciclo di vita} dello sviluppo software, 
con l'obiettivo di garantire che il prodotto finale soddisfi i requisiti prefissati. 
Per monitorare e migliorare i processi, vengono adottate \glossario{metriche} di processo, ovvero indicatori chiave che misurano l'efficienza, l'affidabilità 
...
L'uso delle \glossario{metriche} di processo contribuisce al controllo della qualità e alla riduzione dei rischi associati a ritardi o difetti.
