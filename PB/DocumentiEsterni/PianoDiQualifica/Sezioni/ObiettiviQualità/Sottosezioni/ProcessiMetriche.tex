...
Per ciascun processo delineato dallo standard \glossario{ISO/IEC 12207:1996} e descritto nel documento delle Norme di Progetto, 
...
\begin{table}[H]
    ...
    \hline
        M.PR.LCPM & \makecell{Numero di linee medie \\ di codice per metodo} & $\leq 50$ & $\leq 25$ \\
    \hline
\end{tabular}
...
\begin{table}[H]
    ...
    \hline
\end{tabular}}
\caption{Metriche per processo di Verifica}
