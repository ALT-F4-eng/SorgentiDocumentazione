...
\begin{tikzpicture}
    ...
    \addplot[color=blue] coordinates {(0, 11566) (1, 11880) (2, 11992) (3, 12407) (4, 12676) (5, 12037) (6, 12382) (7, 11718) (8, 11623) (9, 11503) (10, 11503) (11, 11471)};
    \addlegendentry{EAC}
...
\paragraph{Sprint 10}
Il costo stimato alla fine del progetto è di 11503 euro, che corrisponde a circa il 102.0\% del budget totale previsto per il progetto.
Ciò è dovuto al fatto che il costo attuale supera leggermente quello preventivato, portando a una stima finale superiore al budget iniziale.

\paragraph{Sprint 11}
Il costo stimato alla fine del progetto è di 11471 euro, che corrisponde a circa il 101.9\% del budget totale previsto per il progetto.
Ciò è dovuto al fatto che il costo attuale supera leggermente quello preventivato, portando a una stima finale superiore al budget iniziale.