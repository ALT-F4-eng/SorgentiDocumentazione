...
\begin{tikzpicture}
    ...
    \addplot[color=blue, thick,dashed] coordinates {(0, 0) (1, -47.5) (2, -64) (3, -92) (4, -51) (5, -65) (6, -64) (7, -24) (8, 0) (9, 0) (10, 0) (11, -3.8) (12, -3.6)};
    \addlegendentry{SV}
...
\paragraph{Sprint 10}
La \glossario{Schedule Variance} (SV) è di 0, il che significa che il lavoro completato è esattamente in linea con la pianificazione attuale.
La \glossario{Cost Variance} (CV) è di -4.5\%, il che indica che il costo reale è leggermente superiore al valore pianificato ma leggermente in miglioramento rispetto allo sprint precendente.
...
La \glossario{Cost Variance} (CV) è di -4.1\%, il che indica che il costo reale è leggermente superiore al valore pianificato ma leggermente in miglioramento rispetto allo sprint precendente.

\paragraph{Sprint 12}
La \glossario{Schedule Variance} (SV) è pari a -3.6\%, il che indica che il lavoro non procede esattamente secondo la pianificazione attuale e che si è verificato un ritardo.
La \glossario{Cost Variance} (CV) è di -3.5\%, il che indica che il costo reale è leggermente superiore al valore pianificato ma leggermente in miglioramento rispetto allo sprint precendente.
