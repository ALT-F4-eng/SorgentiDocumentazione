...
\begin{itemize}
    ...
    \item \textbf{Prevenzione}: è importante condividere le date in cui verranno svolti gli esami e i periodi in cui si pensa di poter dare meno disponibilità per il progetto.
...
\begin{itemize}
    ...
    \item \textbf{Mitigazione}: in caso di difficoltà è importante che il gruppo si confronti e discuta le problematiche riscontrate, in modo da trovare una soluzione. In caso non si sia in grado di completare un'attività, è opportuno contattare il professore e/o il referente dell'azienda per ricevere supporto.
\end{itemize}
