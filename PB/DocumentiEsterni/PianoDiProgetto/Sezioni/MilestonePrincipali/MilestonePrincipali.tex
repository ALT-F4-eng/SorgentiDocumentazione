...
\begin{itemize}
    \item Responsabile: sono state utilizzate il 46\% delle ore totali del ruolo.
    Quindi il preventivo per il ruolo è stato ecceduto di una soglia accettabile;

    \item Amministratore: sono state utilizzate il 59\% delle ore totali del ruolo.
    Quindi il preventivo per il ruolo è risultato corretto;
    
    
    \item Analista: sono state utilizzate il 95\% delle ore totali del ruolo, quindi il preventivo è risultato troppo stretto.
    ...
    \item Progettista: sono state utilizzate il 0\% delle ore totali del ruolo, infatti come previsto il gruppo ha sviluppato il \glossario{PoC} come un artefatto usa e getta;
    
    \item Programmatore: sono state utilizzate il 20\% delle ore totali del ruolo.
    ...
    \item Verificatore: sono state utilizzate il 40\% delle ore totali del ruolo.
    Dal consuntivo il gruppo ha dedotto che per questo ruolo le ore preventivate fino al termine del progetto non fossero sufficienti. Perciò una buona parte delle ore riassegnate andranno a questo ruolo.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{| l | l | l | l |}
        ...
        \hline 
            \textbf{Totale} & \textbf{217.5} & \textbf{N/A} & \textbf{4471.25€} \\ 
        \hline  
    \end{tabular}}
    \caption{Consuntivo RTB.}
    \label{tab:consuntivo_RTB} 
\end{table}
Il gruppo ha quindi sforato il budget pianificato fino al \glossario{RTB} di una soglia non eccessiva pari a \textbf{206.25€}.
Viene poi riportato in \hyperref[fig:preventivo_consuntivo]{Figura \ref{fig:preventivo_consuntivo}} un diagramma a blocchi che mostra il confronto tra ore preventivate e ore utilizzate per ogni ruolo:
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot coordinates {(Amministratore,32) (Responsabile,20.25) (Analista,74.5) (Progettista, 0) (Programmatore, 31) (Verificatore, 59.75)};
...
\begin{itemize}
    ...
    \item Data di fine: \textbf{30 Maggio 2025}.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{| l | l | l | l |}
        ...
        \hline 
            Verificatore & 109.75 & 15€ & 1646.25€ \\
        \hline 
            \textbf{Totale} & \textbf{350.5} & \textbf{N/A} & \textbf{6773.75€} \\ 
        \hline  
    \end{tabular}}
    \caption{Ripartizione ore e costi fino al PB.}
    \label{tab:stima_costi_PB} 
\end{table}
Considerando il costo già speso, il costo preventivato fino al \glossario{PB} risulta quindi essere pari a \textbf{11245€} lasciando uno scarto di 5€.
