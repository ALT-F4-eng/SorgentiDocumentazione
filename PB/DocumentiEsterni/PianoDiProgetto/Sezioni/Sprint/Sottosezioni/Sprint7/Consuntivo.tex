...
\hyperref[tab:sprint7_ore_consumate]{In tabella \ref{tab:sprint7_ore_consumate}} vengono mostrate le ore preventivate per ruolo per lo \textit{\glossario{Sprint} 7}.
...
\begin{table}[H]
    ...
    \begin{tabular}{| l | l | l | l | l |}
        ...
        \hline
    \end{tabular}
    \caption{Ore consumate per ruolo \glossario{Sprint} 7}
