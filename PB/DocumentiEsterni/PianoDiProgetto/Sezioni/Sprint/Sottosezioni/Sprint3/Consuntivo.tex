...
\hyperref[tab:sprint3_ore_consumate]{In tabella \ref{tab:sprint3_ore_consumate}} vengono mostrate le ore consumate per ruolo per lo \textit{\glossario{Sprint} 3}.
