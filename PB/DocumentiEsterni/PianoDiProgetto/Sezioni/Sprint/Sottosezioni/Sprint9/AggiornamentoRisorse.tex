...
\label{sec:AggiornamentoRisorse_Sprint9}
Al termine dello \textbf{\glossario{Sprint} 9} rimangono le seguenti ore per ruolo: \hyperref[tab:sprint9_ore_rimanenti]{In tabella \ref{tab:sprint9_ore_rimanenti}} vengono mostrate le ore rimanenti per ruolo al termine dello \textit{\glossario{Sprint} 9}.
...
\begin{table}[H]
    ...
    \hline
        Analista & 0 & 0 \\
    \hline
        Verificatore & 109.75 & 93.25 \\
    \hline
        Progettista & 105 & 104 \\
    \hline
    \end{tabular}
    \caption{Ore rimanenti per ruolo.}
    \label{tab:sprint9_ore_rimanenti} 
\end{table}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot coordinates {(Amministratore,5.5) (Responsabile,21.75) (Analista, 0) (Progettista, 104) (Programmatore, 90) (Verificatore, 93.25)};
    ...
    \label{fig:sprint9_risorse_rimanenti}
\end{figure}