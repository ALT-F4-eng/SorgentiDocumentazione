...
\hyperref[tab:sprint2_ore_consumate]{In tabella \ref{tab:sprint2_ore_consumate}} vengono mostrate le ore preventivate per ruolo per lo \textit{\glossario{Sprint} 2}.
...
\begin{table}[H]
    ...
    \hline
    \end{tabular}
    \caption{Ore consumate per ruolo \glossario{Sprint} 2}
