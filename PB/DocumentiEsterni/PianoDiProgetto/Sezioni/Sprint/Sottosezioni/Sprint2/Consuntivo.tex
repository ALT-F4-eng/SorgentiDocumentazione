...
\hyperref[tab:sprint2_ore_consumate]{In tabella \ref{tab:sprint2_ore_consumate}} vengono mostrate le ore consumate per ruolo per lo \textit{\glossario{Sprint} 2}.
