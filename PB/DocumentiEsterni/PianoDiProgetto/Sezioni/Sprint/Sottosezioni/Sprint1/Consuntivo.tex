...
\hyperref[tab:sprint1_ore_consumate]{In tabella \ref{tab:sprint1_ore_consumate}} vengono mostrate le ore consumate per ruolo per lo \textit{\glossario{sprint} 1}.
