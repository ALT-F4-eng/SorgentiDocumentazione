...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Immagini/UC-1.pdf}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Immagini/UC-3.pdf}
    \caption{Diagramma dei Casi d'Uso per UC-3: Eliminazione di coppie domanda-risposta}
    \label{fig:uc3-diagram}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Immagini/UC-4.pdf}
    \caption{Diagramma dei Casi d'Uso per UC-4: Ricerca di coppie domanda-risposta}
    \label{fig:uc4-diagram}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Immagini/UC-5.pdf}
    \caption{Diagramma dei Casi d'Uso per UC-5: Archiviazione di un insieme di coppie domanda-risposta}
    \label{fig:uc5-diagram}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Immagini/UC-6.pdf}
    \caption{Diagramma dei Casi d'Uso per UC-6: Visualizzazione di un insieme di coppie domanda-risposta}
    \label{fig:uc6-diagram}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Immagini/UC-7.pdf}
    \caption{Diagramma dei Casi d'Uso per UC-7: Modifica di un insieme di coppie domanda-risposta archiviate}
    \label{fig:uc7-diagram}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Immagini/UC-8.pdf}
    \caption{Diagramma dei Casi d'Uso per UC-8: Eliminazione di un insieme di coppie domanda-risposta archiviate}
    \label{fig:uc8-diagram}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{../Immagini/UC-9.pdf}
    \caption{Diagramma dei Casi d'Uso per UC-9: Esecuzione del test su un insieme di coppie domanda-risposta}
    \label{fig:uc9-diagram}
\end{figure}
