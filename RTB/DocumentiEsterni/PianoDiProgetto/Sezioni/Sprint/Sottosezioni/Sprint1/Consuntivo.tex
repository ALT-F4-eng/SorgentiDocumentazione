...
\hyperref[tab:sprint1_ore_consumate]{In tabella \ref{tab:sprint1_ore_consumate}} vengono mostrate le ore preventivate per ruolo per lo \textit{\glossario{sprint} 1}.
...
\begin{table}[H]
    ...
    \hline
    \end{tabular}
    \caption{Ore consumate per ruolo \glossario{sprint} 1}
