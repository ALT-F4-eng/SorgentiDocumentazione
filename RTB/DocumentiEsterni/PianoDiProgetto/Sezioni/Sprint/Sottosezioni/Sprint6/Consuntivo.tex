...
\hyperref[tab:sprint6_ore_consumate]{In tabella \ref{tab:sprint6_ore_consumate}} vengono mostrate le ore preventivate per ruolo per lo \textit{\glossario{Sprint} 6}.
...
\begin{table}[H]
    ...
    \begin{tabular}{| l | l | l | l | l |}
        ...
        \hline
    \end{tabular}
    \caption{Ore consumate per ruolo \glossario{Sprint} 6}
