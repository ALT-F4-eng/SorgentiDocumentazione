...
\begin{itemize}
    ...
    \item \textbf{Mitigazione}: Nel caso in cui un membro non fosse disponibile per via di guasti hardware il responsabile deve  rivalutare il Piano di Progetto e rivedere le risorse disponibili per lo \glossario{sprint} in base alla disponibilità degli altri membri.
...
\begin{itemize}
    ...
    Alcuni esempi di tali strumenti sono: sistemi di versionamento del codice, di automazione della build o di containerizzazione (da \glossario{container}). 
    \item \textbf{Pericolosità}: Alta.
    \item \textbf{Probabilità}: Alta.
