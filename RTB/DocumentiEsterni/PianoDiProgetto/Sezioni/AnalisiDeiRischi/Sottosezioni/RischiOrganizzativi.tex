...
\begin{itemize}
    ...
    In casi gravi il responsabile dovrà occuparsi della modifica delle risorse per lo \glossario{sprint} o della scadenza.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Mitigazione}: in caso dovessero verificarsi difficoltà o ritardi è compito del responsabile rivedere il Piano di Progetto e modificare il numero delle risorse allocate per lo \glossario{sprint} o, in casi gravi, la scadenza.
\end{itemize}
...
\begin{itemize}
    ...
    Se quindi uno o più membri del gruppo focalizzeranno il proprio lavoro solo su uno di questi ruoli potrebbero non impiegare tutte le loro ore produttive disponibili durante lo \glossario{sprint}.
    \item \textbf{Pericolosità}: Alta.
    \item \textbf{Probabilità}: Bassa.
    \item \textbf{Prevenzione}: viene creata una tabella per la rendicontazione delle ore per ogni \glossario{sprint} nel piano di progetto che ogni membro dovrà compilare.
    ...
    \item \textbf{Mitigazione}:  Per ogni \glossario{sprint} viene creata una \glossario{dashboard} su \glossario{GitHub} con tutte le attività da svolgere durante lo \glossario{sprint}.
