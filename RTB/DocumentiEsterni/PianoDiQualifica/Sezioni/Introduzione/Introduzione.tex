...
Oltre a ciò, la definizione di \glossario{metriche} di qualità permette di stabilire criteri oggettivi che permettono di validare il prodotto finale 
assicurandone l'affidabilità e la completezza.
Questo documento andrà a indicare:
\begin{itemize}
    \item gli obiettivi di qualità e le \glossario{metriche} associate;
    ...
    \item \glossario{cruscotto di valutazione} della qualità.
\end{itemize}
...
\begin{itemize}
    \item \glossario{Metriche} standard per processi: \url{https://it.wikipedia.org/wiki/Metriche_di_progetto}
\end{itemize}
