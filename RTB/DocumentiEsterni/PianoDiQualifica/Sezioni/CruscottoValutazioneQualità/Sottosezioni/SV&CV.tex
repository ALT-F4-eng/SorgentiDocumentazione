...
ottimistica ed errata del lavoro da svolgere, come visto nel grafico precedente l'Earned Value a ogni \glossario{sprint} è stato notevolmente più basso rispetto al Planned Value
...
La Cost Variance presenta valori negativi inferiori rispetto al valore ammissibile perché, durante gli \glossario{Sprint}, sono state impiegate ore di lavoro per attività non completate. 
...
Ciò avviene perché nel momento in cui attività iniziate durante \glossario{Sprint} precedenti vengono completate l'Earned Value aumenta notevolmente mentre l'incremento dell'Actual Cost è limitato al solo completamento delle attività.