...
ottimistica ed errata del lavoro da svolgere, come visto nel grafico precedente l'\glossario{Earned Value} a ogni sprint è stato notevolmente più basso rispetto al \glossario{Planned Value}
...
La \glossario{Cost Variance} presenta valori negativi inferiori rispetto al valore ammissibile perché, durante gli sprint, sono state impiegate ore di lavoro per attività non completate. 
...
Ciò avviene perché nel momento in cui attività iniziate durante sprint precedenti vengono completate l'\glossario{Earned Value} aumenta notevolmente mentre l'incremento dell'\glossario{Actual Cost} è limitato al solo completamento delle attività.