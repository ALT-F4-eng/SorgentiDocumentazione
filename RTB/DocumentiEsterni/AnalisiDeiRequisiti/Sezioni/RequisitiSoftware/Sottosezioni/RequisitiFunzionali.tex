...
\begin{freq}
    ...
    \subreq{RFF-4.09}{\hyperref[uc:UC-51]{UC-51}, \hyperref[uc:UC-51]{UC-51}}{Il sistema deve visualizzare un bottone che permetta di salvare le modifiche sull'LLM}

    \subreq{RFF-4.10}{\hyperref[uc:UC-51]{UC-51}, \hyperref[uc:UC-51]{UC-51}}{Il sistema deve visualizzare un bottone che permetta di annullare le modifiche sull'LLM}
