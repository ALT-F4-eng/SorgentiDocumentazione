...
I requisiti sono stati definiti tramite l'analisi degli \glossario{use case} individuati dal gruppo, l'analisi del \glossario{capitolato} fornito dall'azienda e le riunioni esterne.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Funzionali (F): \glossario{requisiti software} che soddisfano i comportamenti o le funzionalità del sistema.
        \item Qualitativi (Q): \glossario{requisiti software} necessari per garantire standard qualitativi e di manutenibilità
        del prodotto software.
        \item Di Vincolo/Dominio (V): requisiti che delineano le restrizioni imposte dagli \glossario{Stakeholder} o dal \glossario{capitolato} 
