...
\begin{usecase}{UC-12}{Aggiorna dataset presente nel sistema}
    ...
    \subscenario{
        ...
        \begin{itemize}
            \item Il sistema chiede all'utente se copiare il dataset e aggiornare la copia \hyperref[uc:UC-21]{UC-21}
        ...
        \begin{itemize}
            \item Il sistema chiede all'utente se vuole eliminare i test associati \hyperref[uc:UC-40]{UC-40}
