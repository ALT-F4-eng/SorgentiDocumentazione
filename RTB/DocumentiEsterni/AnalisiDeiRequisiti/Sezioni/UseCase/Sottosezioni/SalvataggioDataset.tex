...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.37]{Sezioni/UseCase/Immagini/SalvataggioDataset.png}
...
\begin{usecase}{UC-14}{Aggiorna dataset presente nel sistema}
    ...
    \subscenario{
        ...
        \begin{itemize}
            \item Il sistema chiede all'utente se copiare il dataset e aggiornare la copia
        ...
        \begin{itemize}
            \item Il sistema chiede all'utente se vuole eliminare i test associati
