...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.47]{Sezioni/UseCase/Immagini/ModificaDatasetSalvato.png}
    \caption{Diagramma modifica dataset salvati.}
\end{figure}

\begin{usecase}{UC-21}{Copia dataset salvato}
    \label{uc:UC-21}
    
    \req{\hyperref[ru:RUO-3]{RUO-3}} 

    \pre{
        \item L'utente sta visualizzando i dataset salvati \hyperref[uc:UC-19]{UC-19}
    }
...
\begin{usecase}{UC-22}{Elimina dataset salvato}
    \label{uc:UC-22}
...
\begin{usecase}{UC-23}{Elimina dataset salvato associato a dei test}
    \label{uc:UC-23}
...
\begin{usecase}{UC-24}{Rinomina dataset salvato}
    \label{uc:UC-24}
    ...
    \scenario{
        ...
        \item Il sistema ottiene il nuovo nome seguendo \hyperref[uc:UC-14]{UC-14}
