...
\begin{usecase}{UC-19}{Visualizza dataset salvati}
    \label{uc:UC-19}
...
\begin{usecase}{UC-20}{Ricerca dataset salvati per nome}
    \label{uc:UC-20}
    ...
    \scenario{
        ...
        \item Il sistema mostra il precedente insieme seguendo \hyperref[uc:UC-19]{UC-19}
    }
    \subscenario{}
\end{usecase}
