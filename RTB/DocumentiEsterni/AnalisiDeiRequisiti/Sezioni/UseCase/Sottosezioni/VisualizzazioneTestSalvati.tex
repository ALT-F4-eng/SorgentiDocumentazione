...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.47]{Sezioni/UseCase/Immagini/VisualizzazioneTestSalvati}
    \caption{Diagramma per la visualizzazione di test salvati.}
\end{figure}

\begin{usecase}{UC-36}{Visualizza test salvati}
    \label{uc:UC-36}
...
\begin{usecase}{UC-37}{Ricerca dei test salvati per nome}
    \label{uc:UC-37}
    ...
    \scenario{
        ...
        \item L'insieme di test ristretto viene visualizzato seguendo \hyperref[uc:UC-36]{UC-36}
    }
    
    \subscenario{}
\end{usecase}

\begin{usecase}{UC-38}{Carica test salvato}
    \label{uc:UC-38}
...
\begin{usecase}{UC-39}{Sovrascrivi test attualmente caricato}
    \label{uc:UC-39}
