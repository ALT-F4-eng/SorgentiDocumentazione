...
\begin{itemize}
    ...
    \item La divisione dei compiti per la stesura dei \glossario{diagrammi \glossario{\glossario{UML}}} di analisi dei requisiti;
...
\begin{itemize}
    \item Non utilizzare i \glossario{diagrammi di gantt} per la pianificazione del progetto poiché non adatti alla suddivisione del lavoro seguendo uno schema \glossario{agile};
...
\begin{itemize}
    \item Fare le \glossario{issue} per i \glossario{diagrammi \glossario{UML}} dei requisiti, dalla \textbf{\#99} alla \textbf{\#109} (Analista);
