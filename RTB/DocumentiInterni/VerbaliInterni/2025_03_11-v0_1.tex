...
\begin{itemize}
    \item Discussione e riflessione sul commento di \glossario{RTB} del Prof. Cardin.
    \item Revisione dei restanti documenti da sistemare per la seconda parte del \glossario{RTB}.
...
\begin{itemize}
    ...
    \item Verificare e validare tutti i documenti in vista della seconda parte del \glossario{RTB}.
    \item Redigere la lettera di presentazione in vista della seconda parte del \glossario{RTB}.
\end{itemize}
