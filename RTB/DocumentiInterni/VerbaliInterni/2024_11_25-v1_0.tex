...
\section{To Do}
    \begin{itemize}
        \item Completare le \glossario{issue} create rispetto alle decisioni prese entro lunedì 2 dicembre (viene indicato tra parentesi il ruolo di competenza per lo svolgimento della \glossario{issue})
        \begin{itemize}
