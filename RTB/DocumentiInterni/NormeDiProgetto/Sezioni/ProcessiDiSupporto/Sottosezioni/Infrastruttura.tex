...
\subparagraph{LTeX+}
LTeX+ è un'estensione che esegue lo "\glossario{spell checking}" dei documenti .tex per installarla basta cercarla nel marketplace di \glossario{Visual Studio Code}.
...
La distribuzione dei documenti avviene tramite un sito web reso accessibile tramite il servizio di hosting offerto da \glossario{GitHub}.
...
\begin{itemize}
    ...
    runner: l'identificativo del runner(\glossario{container}) hostato da \glossario{GitHub} che deve eseguire il job.
    \glossario{GitHub} offre diversi \glossario{container} che variano nella versione/tipo di \glossario{OS} utilizzato.
    Di seguito viene indicato un link che contiene la lista dei runner hostati da \glossario{GitHub} \href{https://docs.github.com/en/actions/writing-workflows/workflow-syntax-for-github-actions#choosing-github-hosted-runners}{runners}. 
...
\begin{itemize}
    \item \textbf{action}: nome di una \glossario{GitHub Action} appartenente al marketplace.
