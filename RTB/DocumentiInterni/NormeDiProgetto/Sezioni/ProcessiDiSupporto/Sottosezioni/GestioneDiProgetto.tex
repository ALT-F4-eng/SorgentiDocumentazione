...
SCRUM richiede l'utilizzo di un \glossario{modello di sviluppo a periodi} chiamati \textbf{\glossario{sprint}}.
...
\begin{enumerate}
    ...
    \item \textbf{Cerimonie}: incontri interni al gruppo eseguite in momenti precisi del \glossario{ciclo di vita} del software.
\end{enumerate}
...
Le cerimonie usate dal gruppo sono: product backlog e \glossario{sprint backlog}. 
...
\glossario{Kanban board} uguale alla product backlog con la differenza che contiene le richieste di modifica dello \glossario{sprint} corrente.
L'implementazione concreta è indicata alla sezione \hyperref[subpar:project]{GitHub projects}.
...
Lo scopo è quello di aggiornare il product backlog e definire quali richieste di modifica in esso contenute devono essere poste nello \glossario{sprint backlog}.
