...
\begin{itemize}
    ...
    È essenziale pianificare le attività che saranno svolte durante il \glossario{ciclo di vita} del progetto, stabilendo le metriche da monitorare e i criteri di accettazione.
...
Per la valutazione della qualità del software con conseguente stesura delle metriche viene seguita la normativa \glossario{ISO/IEC 9126}, secondo lo standard le qualità sono suddivise nelle seguenti categorie:
\begin{itemize}
