...
Utilizza inoltre \glossario{metriche} e strumenti oggettivi per valutare sia l'efficacia dei processi che la qualità dei prodotti.
...
Per l'accertamento della qualità, il gruppo adotta il \glossario{ciclo di Deming}, o PDCA (Plan-Do-Check-Act), un approccio iterativo e continuo volto a migliorare i processi e garantire il raggiungimento degli obiettivi di qualità.
...
Per la valutazione della qualità del software con conseguente stesura delle \glossario{metriche} viene seguita la normativa ISO/IEC 9126, secondo lo standard le qualità sono suddivise nelle seguenti categorie:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Caratteristiche}: presente unicamente nelle \glossario{metriche} di prodotto, indica a quale caratteristica, tra quelle indicate nella sezione relativa allo standard di riferimento, fa riferimento la metrica;
